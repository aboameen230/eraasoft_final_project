...
export default function Contact() {
  ...
  async function submit(event) {
    ...
    try {
      ...
      toast.success("Your message has been sent successfully").then(() => {
  ...
  return (
    <>
      <h1 className="cart-title mt-20 mb-16">My Cart</h1>
      <div className="contact mb-24 flex flex-wrap gap-8 justify-center">
