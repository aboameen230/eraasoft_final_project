  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0 bg-white z-50 ">
      <div className="md:px-10 py-4 px-7 md:flex justify-between items-center">
        ...
        <ul
          className={`gg md:flex md:items-center md:pb-0 pb-12 absolute md:static !bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-20 pl-9 transition-all duration-500 ease-in ${
